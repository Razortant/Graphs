...
\begin{proof}
  ...
  \(A\in[X]^{<\omega}\) is minimal in \(\mathcal{A}\subset[X]^{<\omega}\) if for all \(A'\in\mathcal{A}, A'\preceq A \Rightarrow A \preceq A'\)

  Let us prove that for any given \(n\in\mathbb{N}\), for all bad prefix \(A_0,...,A_{n-1}\in[X]^{<\omega}\), there exists \(A_n\) minimal in \(\{A'/A_0,...,A_{n-1},A_n\text{ is a bad prefix}\}\)

  Let \(n\in\mathbb{N}\), 

  Let \(A_0,...,A_{n-1}\in[X]^{<\omega}\) be a bad prefix

  Let \(\mathcal{B}=\{B\in[X]^{<\omega}/A_0,...,A_{n-1},B\text{ is a bad prefix}\}\) 

  \(\mathcal{B}\) is non-empty so \(\mathcal{B}_\#\) is too

  Therefore, by Zorn's lemma for preorders, there exists \(A_n\in\mathcal{B}\) minimal

  \(A_n\) is minimal in \(\mathcal{B}\)

  We construct a bad sequence by induction.
  ...
  Let \(\mathcal{B}=\{B\in[X]^{<\omega}/B\text{ is a bad prefix}\}\) 

  \(B_0\) is a bad prefix so \(\mathcal{B}\) is non-empty

  Therefore, by Zorn's lemma for preorders, there exists \(A_0\in\mathcal{B}\) such that \(|A_0|=m\)

  \(A_0\) is minimal in \(\mathcal{B}\) which proves the base case

  Using the previous property, we construct inductively the sequence \(\left(A_n\right)_{n\in\mathbb{N}}\) of the minimal elements
...
\begin{theorem}[Kruskal 1960]
  \label{theo:Kruskal} \lean{Kruskal} \uses{Higman}
