...
\begin{proof}
  ...
  A sequence \(\left(B_i\right)_{i\in\N}\in([X]^{<\omega})^\N\) is bad if for all \(i,j\in\N\) with \(i<j\), \(B_i\not\leq B_j\)

  We proceed by induction with the following hypothesis. For any given \(n\in\N\), there exists \(A_0,...,A_{n-1}\in[X]^{<\omega}\) and a bad sequence \(\left(B_i\right)_{i\in\N}\in([X]^{<\omega})^\N\) such that for all \(i<n\), \(A_i=B_i\)

  As \(\leq\) is not a well-quasi-ordering on \([X]^{<\omega}\), there exists \(\left(B_i\right)_{i\in\N}\in([X]^{<\omega})^\N\) a bad sequence.

  Moreover, the condition \(\forall,i<0,A_i=B_i\) is always true which proves the base case

  Let \(n\in\N\), 

  Assume that there exists \(A_0,...,A_{n-1}\in[X]^{<\omega}\) and a bad sequence \(\left(B_i\right)_{i\in\N}\in([X]^{<\omega})^\N\) such that for all \(i<n\), \(A_i=B_i\)

  Let \(\mathcal{B}=\{B\in([X]^{<\omega})^\mathbb{N}/\forall i<n,A_i=B_i\text{ and B is bad}\}\)

  \(\mathcal{B}\) is non empty so we can choose \(B\in\mathcal{B}\) such that for all \(B'\in\mathcal{B}\), \(|B_n|\leq|B'_n|\)
